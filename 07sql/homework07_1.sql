...
-- This query generates the following error: 'Cannot modify a column which maps to a non key-preserved table'.  The department table needs to be updated, but the department ID is not in this view. Therefore, Oracle does not allow us to update any information about the department attributes.
